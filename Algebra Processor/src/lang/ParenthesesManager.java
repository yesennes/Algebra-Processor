...
class ParenthesesManager {
	...
	private static ArrayList<Pattern> levelOfParen = new ArrayList<>();
	private static ArrayList<Pattern> paren = new ArrayList<>();
	private static ArrayList<Pattern> levelOfParenTerm = new ArrayList<>();
	static {
